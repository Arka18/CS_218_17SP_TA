...
;fltTmp1 = radii * ((t + s)/ r2)
	movss 	xmm0, dword [t]
	addss 	xmm0, dword [s] 				;xmm0 = t + s
	divss 	xmm0, dword [r2] 					;xmm0/r2
	mulss 	xmm0, dword [radii] 				;xmm0*radii
	movss 	dword [fltTmp2], xmm0 				;fltTmp1 = xmm0

;xmm1 = offpos * cos (fltTmp1)
	movss 	xmm0, dword [fltTmp2]				;xmm0 = fltTmp1
	call 	cosf 								;cos (fltTmp1)
	mulss 	xmm0, dword [ofp] 					;xmm0 * offpos
	movss 	dword [fltTmp1], xmm0 							;xmm1 = xmm0

; xmm0 = radii * cos(t)
	movss 	xmm0, dword [t]
	call 	cosf								;cos(t)
	mulss 	xmm0, dword [radii]
	addss 	xmm0, dword [fltTmp1] 				;radii * cos(t)
	movss 	dword [x], xmm0

;xmm1 = offpos * sin (fltTmp1)
	movss 	xmm0, dword [fltTmp2]				;xmm0 = fltTmp1
	call 	sinf 								;sin (fltTmp1)
	mulss 	xmm0, dword [ofp] 					;xmm0 * offpos
	movss 	dword [fltTmp1], xmm0 							;xmm1 = xmm0
...
; xmm0 = radii * sin(t)
	...
	call 	sinf								;sin(t)
	mulss 	xmm0, dword [radii]
	addss 	xmm0, dword [fltTmp1] 				;radii * sin(t)
	movss 	dword [y], xmm0
